      ...
      <Layout>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <p className="text-white-50 mb-4">I have everything you need to get your new website up
                  and
                  running in no time! check below services to get started.</p>
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <h3 className="h4 mb-2">Sturdy code</h3>
        ...
        <section className="page-section bg-dark text-white">
          <div className="container text-center">
            <h2 className="mb-4">Free Download this Bootstrap Site!</h2>
            <a className="btn btn-light btn-xl" href="https://github.com/MdRashid62/">Download Now!</a>
          </div>
        </section>
